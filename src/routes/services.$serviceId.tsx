...
export const Route = createFileRoute("/services/$serviceId")({
  head: ({ params }) => {
    ...
    return {
      meta: [
        { title: `${service.title} — Erha Technologies` },
  ...
  return (
    <div className="px-4 sm:px-6 py-16 md:py-24 max-w-7xl mx-auto animate-fade-up">
      ...
      <div className="mb-8">
        ...
        >
          <ChevronLeft size={14} /> Back to All {service.categoryLabel}
        </Link>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8 items-center mb-16">
        ...
        <div className="glass-strong rounded-3xl p-8 border border-slate-800 relative overflow-hidden shadow-2xl">
          ...
          <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs font-mono text-cyan-400">
            ...
            <span className="font-bold">Guaranteed Performance</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-20">
        ...
        <div className="glass-strong rounded-3xl p-8 border border-slate-800">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-black text-white">Included Capabilities</h3>
          </div>
      ...
      {/* ======================================================== */}
      {/* SERVICE-SPECIFIC BUDGET & PRICING TIERS                  */}
      {/* ======================================================== */}
      <div id="pricing-section" className="mb-20 scroll-mt-24">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800 border border-slate-700 text-slate-300 text-xs font-mono font-bold uppercase tracking-widest mb-3">
            <Layers size={14} /> Service Budget & Pricing Tiers
          </div>
          <h2 className="text-3xl sm:text-4xl font-black text-white">
            Transparent Pricing for <span className="text-gradient">{service.shortTitle}</span>
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 mt-2">
            Select the tier matching your project scope or request a custom enterprise quote.
          </p>
        </div>
        ...
        <div className="glass-strong rounded-3xl p-8 sm:p-10 border border-slate-800 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Our engineering lead will review your project requirements and send a customized proposal within 24 hours.
            </p>
          </div>
          ...
          {sent ? (
            <div className="text-center py-10">
              ...
              <p className="text-xs text-slate-300 max-w-md mx-auto">
                Thank you! We have received your request for <strong>{service.title} ({form.tier} Tier)</strong>.
              </p>
            </div>
          ) : (
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-xs text-slate-300 font-semibold mb-1 block">Selected Tier</label>
                  <select
                    value={form.tier}
                    onChange={(e) => setForm({ ...form, tier: e.target.value })}
                    className="w-full px-4 py-3 rounded-xl bg-slate-950/80 border border-slate-800 text-sm text-white focus:border-cyan-400 focus:outline-none"
                  >
                    <option value="Starter">Starter Tier ({service.pricingTiers.starter.price})</option>
                    <option value="Professional">Professional Tier ({service.pricingTiers.professional.price})</option>
                    <option value="Enterprise">Enterprise Tier ({service.pricingTiers.enterprise.price})</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Share details about your timeline, current stack, or custom expectations..."
                />
              </div>
              ...
              >
                {isSubmitting ? "Submitting Request..." : "Submit Proposal Request"} <Send size={14} />
              </button>
            </form>
          )}
        </div>
      ...
      {/* ======================================================== */}
      {/* RELATED SERVICES CAROUSEL / NAVIGATION                   */}
      {/* ======================================================== */}
