...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn about Erha Technologies, a Pakistan-based AI and digital innovation company founded by Ilyas Shahid." },
  ...
  return (
    <div className="px-6 py-24 max-w-6xl mx-auto animate-fade-up">
      <div className="text-center mb-20">
        <div className="text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)] mb-4">About Us</div>
        <h1 className="font-display text-5xl md:text-7xl mb-6">
          Engineering <span className="text-gradient">the future</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          ERHA TECHNOLOGIES is a forward-thinking digital solutions provider dedicated to empowering businesses through cutting-edge technology. We specialize in high-impact Artificial Intelligence integration and a comprehensive suite of digital services designed to streamline operations and drive growth.
        </p>
      </div>

      {/* Founder */}
      <div className="glass-strong rounded-3xl p-10 md:p-14 mb-16 relative overflow-hidden">
        <div className="orb" style={{ width: 400, height: 400, background: "var(--neon-cyan)", top: -100, left: -100 }} />
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        {[
          { icon: Target, title: "Mission", text: "Empower businesses with AI-driven solutions that simplify complexity and unlock growth." },
          { icon: Eye, title: "Vision", text: "Become a global leader in agentic AI and digital engineering — born from Pakistan, built for the world." },
          { icon: Rocket, title: "Values", text: "Innovation, craftsmanship, transparency, and an obsession with shipping excellence." },
        ].map((c) => (
      ...
      <div className="text-center">
        <Link to="/contact" className="btn-neon px-7 py-3 rounded-full inline-flex">Work with us</Link>
      </div>
    </div>
  );
}
